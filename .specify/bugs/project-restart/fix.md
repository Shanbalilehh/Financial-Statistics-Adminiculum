# Bug Fix: `project` Service in `compose.yaml` Restarts Indefinitely

- **Slug**: project-restart
- **Fixed**: 2026-09-19T18:58:00-05:00
...
- Run `/speckit-bug-test slug=project-restart` to perform end-to-end verification of the bug resolution.
